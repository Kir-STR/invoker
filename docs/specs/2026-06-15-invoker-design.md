...
`invoker` — Claude Code plugin, который привносит в произвольный проект **дисциплинарный слой + движок эволюции правил для AI-агентов**. Это набор правил, перенесённый из рабочего проекта и очищенный от его специфики, чтобы работать в любом другом.
...
## 6. Поток `ivk retro` (движок эволюции)
